...
/*
// it's have image in question show button automatically show

let showImageButton = document.querySelector(".show-image-button button");

if (!questions[que_count].image) {
  showImageButton.style.display = "none";
} else {
  showImageButton.style.display = "block";
  showImageButton.addEventListener("click", function () {
    let questionImage = document.querySelector(".question-image img");
    questionImage.src = questions[que_count].image;
...
showImageButton.addEventListener("click", function () {
  modalImage.src = questions[que_count].image;
...
/*
// image button show when have image and popup image 
